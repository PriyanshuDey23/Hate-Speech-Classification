...
# Call the pipeline  (src\Hate_Speech_Classification\pipeline\stage_04_model_trainer.py) in main .py 

from Hate_Speech_Classification.pipeline.stage_04_model_trainer import ModelTrainerTrainingPipeline
